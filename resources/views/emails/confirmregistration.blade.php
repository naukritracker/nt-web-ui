...
<html lang="en">
    ...
    <body>
        ...
        <div class="container pad-t80">
        	...
        	<p>Here at <a href="{{ URL::route('Home') }}" target="_blank">Naukri Tracker</a>, we believe that the abilities of each and every individual has the potential to be utilized in the best possible manner. We live by this core concept and truly have faith that we can help you find that perfect fit in that perfect job.</p>

        	<p>With that said, we would like to officially welcome you to <a href="{{ URL::route('Home') }}" target="_blank">Naukri Tracker</a>. Please click <a href="{{$link}}" target="_blank" style="color:green">here</a> or else use the link provided below to validate your email address so as to help us provide the latest opportunities best suited for you as an individual.</p>	
